...
<main role="main" class="container pt-5 mt-5 pb-5">
    <article class="project-container">
        ...
        <div class="text-center">
            <?php 
            $rutaImg = !empty($proyecto['imagen']) 
                       ? base_url(['img',  $proyecto['imagen']]) 
                       : base_url('img/generica.jpg'); 
            ?>
            <img src="<?= $rutaImg ?>" class="img-detail" alt="<?= esc($proyecto['titulo']) ?>">
        </div>
        ...
        <footer class="mt-5 pt-4 border-top">
            <?php if (!empty($proyecto['adjunto'])): ?>
                <div class="alert alert-light d-flex align-items-center justify-content-between p-4 shadow-sm">
                    <div>
                        ...
                        <p class="mb-0 small text-muted">Descarga los archivos técnicos de este proyecto.</p>
                    </div>
                    <a href="<?= base_url(['files', $proyecto['adjunto']]) ?>" class="btn-download" target="_blank">
            ...
            <div class="mt-4">
                <a href="<?= base_url('proyectos') ?>" class="text-decoration-none text-muted">
                    <i class="bi bi-arrow-left"></i> Volver al listado de proyectos
                </a>
            </div>
        </footer>
